...
namespace DSPRE.Avalonia.Views
{
    ...
    ///
    /// One column of pixels stands for however many samples fall under it, drawn from the quietest to the
    /// loudest of them. Picking one sample per column instead would miss most of the sound and draw a
    /// shape that changes every time the window is resized.
    /// </summary>
