...
namespace DSPRE.Avalonia.Views
{
    ...
    ///
    /// The waveform underneath says how loud the music is; this says what it is playing. They answer
    /// different questions, so both are shown. Each track of the sequence gets its own colour, because
    /// what people usually want to see is which part is carrying the tune.
    /// </summary>
