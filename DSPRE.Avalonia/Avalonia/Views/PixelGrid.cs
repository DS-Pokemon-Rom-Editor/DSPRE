...
{
    /// <summary>
    /// A line between every pixel of a blown-up drawing, drawn over the top of it.
    ///
    /// It sits in the same spot and at the same size as the picture, so the lines land exactly on the
    /// pixel edges. The lines are half transparent white and half transparent black, one over the other,
    /// so they show up on a light drawing and a dark one alike without either colour winning.
    /// </summary>
