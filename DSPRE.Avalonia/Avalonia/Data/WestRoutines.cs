...
namespace DSPRE.Avalonia.Data
{
    ...
    public static class WestRoutines
    {
        ...
        // EMIT_STRAIGHT and EMIT_PARABOLIC share one reader, EmitMove_Init, and are its only two
        // callers. The other two emitter routines look similar and are not.
        ...
        {
            new WestRoutine { Id = 0, Name = "TEST_1", Summary = "A sample routine the games left in. Does nothing.", Source = "WestSp_Sample" },
            new WestRoutine { Id = 1, Name = "TEST_2", Summary = "A sample routine the games left in. Does nothing.", Source = "WestSp_SampleEffectTCB" },
            new WestRoutine { Id = 2, Name = "TEST_3", Summary = "A sample routine the games left in. Does nothing.", Source = "WestSp_SampleSoundTCB" },
            new WestRoutine { Id = 3, Name = "TEST_4", Summary = "A sample routine the games left in. Does nothing.", Source = "WestSp_SampleTCB" },

            new WestRoutine { Id = 4, Name = "POKEROTA_00", Summary = "Turns the attacker on the spot.",
                Source = "WestSp_EffectTCBPokeRota00",
            ...
            new WestRoutine { Id = 5, Name = "WE_070", Summary = "Squashes the attacker down (Strength).",
                Source = "WestSp_WE_070",
                Words = new[] { "how far down to squash, as a percentage", "", "how many frames the squash takes", "" } },

            new WestRoutine { Id = 6, Name = "WE_339", Summary = "One move's own effect.", Source = "WestSp_WE_339", Words = new[] { "" } },
            new WestRoutine { Id = 7, Name = "WE_104", Summary = "One move's own effect.", Source = "WestSp_WE_104", Words = new[] { "" } },
            new WestRoutine { Id = 8, Name = "WE_098", Summary = "One move's own effect.", Source = "WestSp_WE_098" },
            new WestRoutine { Id = 9, Name = "WE_065", Summary = "One move's own effect.", Source = "WestSp_WE_065" },

            new WestRoutine { Id = 10, Name = "WE_066", Summary = "Turns the attacker while moving it.",
                Source = "WestSp_WE_066",
                Words = new[] { "where the turn starts", "where it ends", OwnWay } },

            new WestRoutine { Id = 11, Name = "WE_093", Summary = "One move's own effect.", Source = "WestSp_WE_093" },
            new WestRoutine { Id = 12, Name = "WE_151", Summary = "One move's own effect.", Source = "WestSp_WE_151" },
            new WestRoutine { Id = 13, Name = "WE_074", Summary = "One move's own effect.", Source = "WestSp_WE_074" },
            new WestRoutine { Id = 14, Name = "WE_096", Summary = "One move's own effect.", Source = "WestSp_WE_096" },
            new WestRoutine { Id = 15, Name = "WE_100", Summary = "One move's own effect.", Source = "WestSp_WE_100" },
            new WestRoutine { Id = 16, Name = "WE_148", Summary = "Whitens the background and darkens the attacker together, holds, then brings both back.",
                Source = "WestSp_WE_148" },
            new WestRoutine { Id = 17, Name = "WE_101AT", Summary = "One move's own effect, on the attacker.", Source = "WestSp_WE_101AT" },
            new WestRoutine { Id = 18, Name = "WE_101DF", Summary = "One move's own effect, on the defender.", Source = "WestSp_WE_101DF" },
            new WestRoutine { Id = 19, Name = "WE_150", Summary = "One move's own effect.", Source = "WestSp_WE_150" },
            new WestRoutine { Id = 20, Name = "WE_180", Summary = "One move's own effect.", Source = "WestSp_WE_180" },
            new WestRoutine { Id = 22, Name = "WE_107", Summary = "One move's own effect.", Source = "WestSp_WE_107", Words = new[] { "" } },
            new WestRoutine { Id = 23, Name = "WE_185", Summary = "One move's own effect.", Source = "WestSp_WE_185" },
            new WestRoutine { Id = 24, Name = "WE_089", Summary = "One move's own effect.", Source = "WestSp_WE_089", Words = new[] { "" } },

            new WestRoutine { Id = 25, Name = "WE_204", Summary = "One move's own effect.", Source = "WestSp_WE_204", Words = new[] { OwnWay } },
            new WestRoutine { Id = 26, Name = "WE_171", Summary = "One move's own effect.", Source = "WestSp_WE_171", Words = new[] { OwnWay } },

            new WestRoutine { Id = 27, Name = "WE_175 / SHAKE", Summary = "Shakes a Pokemon, in one of two ways.",
                Source = "WestSp_WE_175",
            ...
            new WestRoutine { Id = 28, Name = "WE_222", Summary = "One move's own effect.", Source = "WestSp_WE_222", Words = new[] { "" } },
            new WestRoutine { Id = 29, Name = "WE_216", Summary = "One move's own effect.", Source = "WestSp_WE_216" },
            new WestRoutine { Id = 30, Name = "WE_233", Summary = "One move's own effect.", Source = "WestSp_WE_233" },
            new WestRoutine { Id = 31, Name = "WE_207_MAIN", Summary = "One move's own effect.", Source = "WestSp_WE_207_MAIN" },
            new WestRoutine { Id = 32, Name = "WE_262", Summary = "One move's own effect.", Source = "WestSp_WE_262" },

            new WestRoutine { Id = 33, Name = "HAIKEI_PAL_FADE", Summary = "Fades the background's colours toward one colour and back.",
                Source = "WestSp_WE_HaikeiPalFade",
            ...
            new WestRoutine { Id = 34, Name = "SSP_POKE_PAL_FADE", Summary = "Flashes a Pokemon a colour, over and over.",
                Source = "WestSp_WE_SSPPokePalFade",
            ...
            new WestRoutine { Id = 35, Name = "CAP_POKE_SCALE_UPDOWN", Summary = "Grows and shrinks a dropped copy of a Pokemon.",
                Source = "WestSp_WE_CAPPokeScaleUpDown",
            ...
            new WestRoutine { Id = 40, Name = "SSP_POKE_VANISH", Summary = "Hides or shows a Pokemon.",
                Source = "WestSp_WE_SSP_PokeVanish",
                Words = new[] { Flag, "0 to show it, anything else to hide it" } },

            new WestRoutine { Id = 41, Name = "WE_252_BACK", Summary = "One move's own effect, on the background.", Source = "WestSp_WE_252Back" },

            new WestRoutine { Id = 42, Name = "SSP_POKE_SCALE_UPDOWN", Summary = "Squashes and stretches a Pokemon, over and over.",
                Source = "WestSp_WE_SSPPokeScaleUpDown",
            ...
            new WestRoutine { Id = 43, Name = "WE_252_POKE", Summary = "One move's own effect, on a Pokemon.", Source = "WestSp_WE_252SSPPoke" },

            new WestRoutine { Id = 44, Name = "WE_T02", Summary = "Slides a background across the screen behind the battle.",
                Source = "WestSp_WE_T02",
            ...
            new WestRoutine { Id = 45, Name = "WE_T22", Summary = "Slides a background across the screen behind the battle.",
                Source = "WestSp_WE_T22",
                Words = new[] { "which background to use", "where it starts, across", "where it starts, down",
                                "how fast it moves across", "how fast it moves down",
                                "whether to turn it around when the enemy is attacking",
                                "how solid it is", "how many frames it lasts" } },

            new WestRoutine { Id = 47, Name = "WE_224AT", Summary = "One move's own effect, on the attacker.", Source = "WestSp_WE_224AT" },
            new WestRoutine { Id = 48, Name = "WE_224DF", Summary = "One move's own effect, on the defender.", Source = "WestSp_WE_224DF" },

            new WestRoutine { Id = 49, Name = "WE_057", Summary = "The Surf wave.", Source = "WestSp_WE_057", Words = new[] { OwnWay } },

            new WestRoutine { Id = 50, Name = "WE_T03", Summary = "Blinks a Pokemon in and out.", Source = "WestSp_WE_T03",
                Words = new[] { "how many times it blinks (the routine doubles this)", "how many frames each blink takes" } },

            new WestRoutine { Id = 51, Name = "WE_T04", Summary = "Slides a Pokemon sideways and back.", Source = "WestSp_WE_T04",
                Words = new[] { "how many frames the slide takes", "how far it goes across", Flag } },

            new WestRoutine { Id = 52, Name = "WE_T05", Summary = "Slides a Pokemon sideways and back.", Source = "WestSp_WE_T05",
                Words = new[] { "how many frames the slide takes", "how far it goes across", Flag } },

            new WestRoutine { Id = 53, Name = "WE_T06", Summary = "Slides a Pokemon and holds it there.", Source = "WestSp_WE_T06",
                Words = new[] { "where the slide starts", "", "where it ends", "",
                                "how many frames to hold before coming back", Flag } },

            new WestRoutine { Id = 55, Name = "WE_293", Summary = "One move's own effect.", Source = "WestSp_WE_293" },

            new WestRoutine { Id = 56, Name = "WE_T08", Summary = "Puts a glow around the attacker (Superpower).", Source = "WestSp_WE_T08",
                Words = new[] { OwnWay, "" } },

            new WestRoutine { Id = 57, Name = "WE_T10", Summary = "Slides a Pokemon and brings it back.", Source = "WestSp_WE_T10",
                Words = new[] { "how many frames the slide takes", "how far it goes across", "how far it goes down", Flag } },

            new WestRoutine { Id = 58, Name = "WE_102", Summary = "One move's own effect.", Source = "WestSp_WE_102" },
            new WestRoutine { Id = 59, Name = "WE_325", Summary = "One move's own effect.", Source = "WestSp_WE_325", Words = new[] { "" } },

            new WestRoutine { Id = 60, Name = "WE_KAITEN", Summary = "Swings a Pokemon around in a circle.", Source = "WestSp_WE_Kaiten",
                Words = new[] { Flag, "where the swing starts", "where it ends" } },

            new WestRoutine { Id = 61, Name = "WE_DISP_OUT", Summary = "Slides a Pokemon off the screen.", Source = "WestSp_WE_DispOut",
                Words = new[] { Flag, "how many frames it takes" } },

            new WestRoutine { Id = 62, Name = "WE_DISP_DEF", Summary = "Puts a Pokemon straight back where it belongs.", Source = "WestSp_WE_DispDef",
                Words = new[] { Flag } },

            new WestRoutine { Id = 63, Name = "WE_OAM_PAL_FADE", Summary = "Fades the colours of dropped copies toward one colour.",
                Source = "WestSp_WE_OAM_PalFade",
            ...
            new WestRoutine { Id = 68, Name = "BG_SHAKE", Summary = "Shakes the background.", Source = "WestSp_WE_BgShake",
            ...
            new WestRoutine { Id = 69, Name = "MOSAIC", Summary = "Breaks a dropped copy into blocks and back.", Source = "WSP_Mosaic",
            ...
            new WestRoutine { Id = 70, Name = "WSP_272", Summary = "One move's own effect.", Source = "WSP_272", Words = new[] { "" } },
            new WestRoutine { Id = 71, Name = "WSP_289", Summary = "One move's own effect.", Source = "WSP_289", Words = new[] { Flag } },

            new WestRoutine { Id = 72, Name = "EMIT_ROTATION", Summary = "Swings a particle emitter around a Pokemon.",
                Source = "WSP_Emitter_Rotation",
            ...
            new WestRoutine { Id = 76, Name = "LASTER", Summary = "Ripples the screen line by line.", Source = "WestSp_WE_Laster",
                Words = new[] { "how many frames the ripple lasts" } },

            new WestRoutine { Id = 77, Name = "DISP_MOVE", Summary = "Slides a Pokemon off the screen or back on.", Source = "WestSp_WE_DispMove",
            ...
            new WestRoutine { Id = 78, Name = "ALL_DROP", Summary = "Keeps all four Pokemon drawn as sprites while the particle data loads.",
                Source = "WSP_AllPokeDrop",
                Words = new[] { "how many frames to keep them drawn, or 0 for the usual loading wait" } },

            new WestRoutine { Id = 79, Name = "WSP_166", Summary = "One move's own effect.", Source = "WSP_166", Words = new[] { "" } },

            // Both read their two words through StatusEffect_Param_SetUp.
            new WestRoutine { Id = 82, Name = "ST_EFF_RECOVER", Summary = "Scrolls an overlay upward behind a Pokemon, for getting its health back.",
                Source = "StatusEffect_Recover",
