    ...
    public class TrophyGardenEncounterFile : RomFile {
        ...
        public bool SaveToNarc(bool showSuccessMessage = true) {
            try {
                ...
                if (showSuccessMessage) {
                    System.Windows.Forms.MessageBox.Show(
                        "Trophy Garden encounters saved successfully!",
                        "Success",
                        System.Windows.Forms.MessageBoxButtons.OK,
                ...
                System.Windows.Forms.MessageBox.Show(
                    $"Error saving Trophy Garden encounters: {ex.Message}",
                    "Error",
                    System.Windows.Forms.MessageBoxButtons.OK,
                    System.Windows.Forms.MessageBoxIcon.Error);
                return false;
        ...
        public bool ExportToFile(string path, bool showSuccessMessage = true) {
            try {
                ...
                if (showSuccessMessage) {
                    System.Windows.Forms.MessageBox.Show(
                        "Trophy Garden encounters exported successfully!",
                        "Success",
                        System.Windows.Forms.MessageBoxButtons.OK,
                        System.Windows.Forms.MessageBoxIcon.Information);
                }
                ...
                System.Windows.Forms.MessageBox.Show(
                    $"Error exporting Trophy Garden encounters: {ex.Message}",
                    "Error",
                    System.Windows.Forms.MessageBoxButtons.OK,
                    System.Windows.Forms.MessageBoxIcon.Error);
                return false;
        ...
        public bool ImportFromFile(string path) {
            try {
                ...
                System.Windows.Forms.MessageBox.Show(
                    $"Error importing Trophy Garden encounters: {ex.Message}",
                    "Error",
                    System.Windows.Forms.MessageBoxButtons.OK,
                    System.Windows.Forms.MessageBoxIcon.Error);
                return false;
