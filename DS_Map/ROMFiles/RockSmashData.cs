...
namespace DSPRE.ROMFiles
{
    ...
    /// Smash encounter fails to produce a wild Pokémon. One 4-byte file per Map Header ID.
    ...
    public class RockSmashData
    {
        ...
        /// <summary>False if a/2/5/3 had no file for this header (a modified ROM missing NARC
        /// entries, or a header added without a matching Rock Smash file). SaveToFile creates it.</summary>
        public bool Existed;
