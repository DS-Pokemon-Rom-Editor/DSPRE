// NSBMDGlRenderer.cs
// TODO (Avalonia migration - step 33): Replace this stub with a full
//      OpenTK 4.x implementation hosted in an Avalonia NativeControlHost.
//
// The pure math helpers (Sign, loadIdentity, multMatrix, Translate, Rotate,
// scale) are FULLY FUNCTIONAL because they are called from the data-parsing
// layer (NSBMD.cs, NSBMDObject.cs, NSBCA.cs) and must not be broken.
