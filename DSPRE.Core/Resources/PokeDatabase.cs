...
namespace DSPRE.Resources {
    public static class PokeDatabase {
        ...
        public static class MapType {
            public static string[] DPPtValues = new string[] {
                "[000] None",
                "[001] Town",
                "[002] Route",
                "[003] Cave",
        ...
        public static class Weather {
            public static Dictionary<int, string> DPWeatherDict = new Dictionary<int, string> {
                ...
                [23] = "Canopy",
                [24] = "By season: Route 212 south",
                [25] = "By season: Route 213",
                [26] = "By season: Route 216",
                [27] = "By season: Lake Acuity",
                [28] = "By season: Snowpoint City",
            };
            public static Dictionary<int, string> PtWeatherDict = new Dictionary<int, string> {
                ...
                [30] = "Dim light",
                [31] = "Normal [31]",
                [32] = "By season: Route 212 south",
                [33] = "By season: Route 213",
                [34] = "By season: Route 216",
                [35] = "By season: Acuity Lakefront",
                [36] = "By season: Snowpoint City",
            };
