...
{
    /// <summary>
    /// The event_type table mirrors fieldobj_code.h: HGSS defines 0x00-0x09, DP/Pt adds the fleeing
    /// trainer at 0x0a. Every trainer variant is a trainer to the engine, which is what decides whether
    /// the script number is a trainer id.
    /// </summary>
