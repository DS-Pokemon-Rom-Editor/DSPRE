...
namespace DSPRE.Tests
{
    ...
    /// Terrain animation is a plain NSBTA (mapresource.c picks one per area via RESOURCE_PARAM.ground_anm),
    /// so these confirm the parser copes with what the game actually ships. Skipped when the ROM isn't there.
    /// </summary>
