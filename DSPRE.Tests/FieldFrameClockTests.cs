...
{
    /// <summary>
    /// The preview has to keep time with the real game. Windows wakes a timer every 15.6ms, so these
    /// check the clock against the tick lengths that actually happen rather than a tidy 33.3ms.
    /// </summary>
