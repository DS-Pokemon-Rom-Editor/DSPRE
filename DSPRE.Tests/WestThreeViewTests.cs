...
{
    /// <summary>
    /// The three ways of reading a move script.
    ///
    /// None of them writes a command out as a sentence; these are instruction streams with timing in
    /// them. What is checked here is that the two readable views name the things the games give names to
    /// rather than leaving a bare number, that the raw view leaves everything exactly as it is, and that
    /// renaming a routine reaches all three.
    /// </summary>
    [Collection("rom")]
    public class WestThreeViewTests
    {
        ...
        /// <summary>
        /// The guided view reads front to back, and its ending is at the end.
        ///
        /// A move that branches carries a spare SEQEND early in the file, and while the headings came out in
        /// the order they were first seen that put "Where it ends" in the middle of the move with more of it
        /// underneath. Every script in the game is checked, because only 22 of them branch.
        /// </summary>
        [Fact]
