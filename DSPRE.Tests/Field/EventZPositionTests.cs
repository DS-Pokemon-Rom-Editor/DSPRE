...
{
    /// <summary>
    /// The Z box is shared by all four event kinds but the underlying field is not: overworlds store 16.16
    /// fixed point, triggers and spawnables store a plain value.
    /// </summary>
