...
namespace DSPRE.Tests
{
    ...
    public class FieldMessageWindowTests
    {
        ...
        public void TheBoxSitsWhereTheGamesPutIt()
        {
            ...
            // BmpTalkWinWriteMain puts two tile columns left of the writing and three right of it, plus a
            // row above and below, which for this window is the whole screen width and the bottom forty
            // eight pixels.
