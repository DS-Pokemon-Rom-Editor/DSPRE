...
namespace DSPRE.Tests
{
    ...
    ///
    /// A BCA0 file's JNT0 block holds a sixteen character name per animation, which is what the people who
    /// built the models called each one. The reader already picked those up; nothing used them.
    ///
    /// Swept across every movement file in the games rather than a few, because "the names are there" is
    /// only worth saying if they are there in most of them.
    /// </summary>
    [Collection("rom")]
