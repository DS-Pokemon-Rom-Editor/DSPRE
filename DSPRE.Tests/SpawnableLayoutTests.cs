...
{
    /// <summary>
    /// The spawnable record is the engine's BG_TALK_DATA: id, type, int gx, int gz, int height,
    /// dir, padding. Reading gx/gz/height as 16-bit halves put height two bytes early, so editing
    /// it wrote into the top half of gz instead.
    /// </summary>
