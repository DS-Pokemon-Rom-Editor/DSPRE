...
{
    /// <summary>
    /// Records taken verbatim from HeartGold's outdoor building-animation list, so the layout is
    /// pinned against real data rather than only against the struct definition.
    /// </summary>
