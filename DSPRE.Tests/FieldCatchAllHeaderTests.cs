...
{
    /// <summary>
    /// The header every unwalked matrix square belongs to.
    ///
    /// HeartGold names header 0 "EVERYWHERE" and gives it 291 of its matrix's 47 by 17 squares. Sweeping
    /// all 540 of the game's headers, it is the only one owning more than 32; the largest header for a
    /// place somebody can stand in owns 6. So there is a wide gap to put the line in.
    /// </summary>
