...
{
    /// <summary>
    /// Walkability across a matrix of maps. The games test bit 15 of a tile's attribute (GetHitAttr),
    /// which is the top bit of the collision byte a map file stores.
    /// </summary>
