...
namespace DSPRE.Tests
{
    ...
    public class SseqWholeArchiveSmokeTests
    {
        ...
        // Platinum's own file name, verified directly against the leaked source (main/src/system/snd_system.c):
        // NNS_SndArcInit(..., "data/sound/pl_sound_data.sdat", ...). Same container/SSEQ/SBNK/SWAV format as
        ...
        // DP's file name is genuinely different from Platinum's, not just "whatever Plat uses" — confirmed via
        // the same leaked snd_system.c, which has DP's original call ("data/sound/sound_data.sdat", no prefix)
        // commented out directly above the Platinum one it was replaced with.
