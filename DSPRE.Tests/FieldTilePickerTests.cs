...
{
    /// <summary>
    /// Finding the tile under a point on screen. Dragging something across the map asks this on every
    /// twitch of the pointer, and a header that stitches the whole matrix carries about three hundred
    /// thousand tiles, so the prepared form works out where everything landed once and buckets it.
    /// </summary>
