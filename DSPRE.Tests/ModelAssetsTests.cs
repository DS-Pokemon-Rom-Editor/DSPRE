...
namespace DSPRE.Tests
{
    ...
    ///
    /// Same rule as the flat graphics: nothing is allowed to come back blank with nothing said. This walks
    /// every entry of every 3D archive in every game, not a sample, because the one that fails silently is
    /// exactly the one a sample would skip.
    /// </summary>
    [Collection("rom")]
