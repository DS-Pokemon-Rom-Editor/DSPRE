...
namespace DSPRE.Tests
{
    ...
    /// The list holds one 24-byte entry per building model naming up to four animations, and the archive
    /// mixes four kinds: texture scrolling, joint movement, texture swapping and material colour.
