...
{
    /// <summary>
    /// Choosing where a walk starts. The preview can begin next to any of the map's events, or anywhere
    /// you drop the marker, so these cover the tile arithmetic both of those rely on.
    /// </summary>
