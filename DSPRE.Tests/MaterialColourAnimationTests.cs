...
{
    /// <summary>
    /// Material animations (NSBMA) from a real HeartGold project: the ones that fade a material in and
    /// out. Skipped when no local project is present.
    /// </summary>
    public class MaterialColourAnimationTests
    {
        ...
        public void TheFadeNamesAMaterialItsModelActuallyHas()
        {
            ...
            // material names, so the renderer can match them. Building model 305 owns ob_lgsz4, and
            // animations 216 and 218 are the pair that fade it in and out.
