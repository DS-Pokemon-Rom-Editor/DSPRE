...
namespace DSPRE.Tests
{
    ...
    /// about rather than its textures. Turning is stored as a six-byte "pivot" record, and these check the
    /// matrices that come out are real ones. Skipped when no local project is present.
    /// </summary>
