...
namespace DSPRE.Tests
{
    ...
    public class FieldFontTests
    {
        ...
        {
            // This is the check that says the pixels are being unpacked correctly. Read the rows the
            // wrong way round, or take the wrong byte of each pair, and the ink spills past the width
            // the font itself declares. Every single letter has to pass, not most of them.
            var font = Talk();
