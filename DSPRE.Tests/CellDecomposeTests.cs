...
namespace DSPRE.Tests
{
    ...
    ///
    /// The browser shows a thing the way the game puts it together, so an HP bar looks like the box you
    /// see in a battle rather than a heap of pieces. This is the way back: paint that picture, and the
    /// pieces are read out of it again.
    ///
    /// What has to be true is that taking a picture apart and drawing it again gives the same picture. If
    /// the way back is not the exact inverse of the way there, an edit lands in the wrong pieces, and it
    /// would look like the paint had simply not worked.
    ///
    ...
    public class CellDecomposeTests
    {
        ...
        /// was painted. Without this, "it came back the same" would also be true of a write that did
        /// nothing at all.
        /// </summary>
        [Fact]
