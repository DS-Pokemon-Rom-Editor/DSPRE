...
{
    /// <summary>
    /// Idle motion for the preview. Timings come from the games: 16/32/48/64 frame pauses for random
    /// turning and wandering (DATA_MvDirRndWaitTbl), 24 frames per turn for spins (MV_SPIN_WAIT_FRAME).
    /// </summary>
