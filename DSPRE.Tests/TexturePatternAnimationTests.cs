...
{
    /// <summary>
    /// Texture-swapping animations (NSBTP), read from a real HeartGold project. These are the flashing
    /// lanterns, lit windows and opening lift doors: the material stays put and the picture on it changes.
