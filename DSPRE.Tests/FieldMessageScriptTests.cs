...
namespace DSPRE.Tests
{
    ...
    /// A line break just drops a line. A "\r" waits and then wipes the box. A "\f" waits and then slides
    /// everything up one line, which is not the same thing as a fresh page and is the one that is easy
    /// to get wrong.
    /// </summary>
